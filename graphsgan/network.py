...
from graphsgan.functional import  LinearWeightNorm

class Discriminator(nn.Module):
    def __init__(self, input_dim = 1533, output_dim = 8):
    ...
    def forward(self, x, feature = False, cuda = True, first = False):
...
class Generator(nn.Module):
    ## Generator has two 500-units hidden layers, each followed by a batch normalization layer.
    def __init__(self, z_dim, output_dim = 1533):
    ...
    def forward(self, batch_size, cuda = True, seed = -1):
